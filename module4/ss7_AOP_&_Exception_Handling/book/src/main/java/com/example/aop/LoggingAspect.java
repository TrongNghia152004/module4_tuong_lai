...
public class LoggingAspect {
    @Pointcut("execution(* com.example.controller.BookController.performBorrow(..))")
    public void loggingPerformBorrowPointCut(){}
    @Pointcut("execution(* com.example.controller.BookController.performGiveBack(..))")
    public void loggingPerformGiveBackPointCut() {}
    @Pointcut("execution(* com.example.controller.BookController.showAllList(..))")
